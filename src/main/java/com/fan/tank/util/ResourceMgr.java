...
public class ResourceMgr {
    ...
    static {
        try {
            ...
            ammo = ImageIO.read(Objects.requireNonNull(ResourceMgr.class.getClassLoader().getResourceAsStream("images/ammo.png")));
            for(int i=0; i<16; i++)
    ...
    public static void main(String[] args) {
        System.out.println(ResourceMgr.ammo);
        System.out.println(ResourceMgr.badTankD);
    }
}
